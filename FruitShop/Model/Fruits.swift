...
struct Fruit: Identifiable, Hashable {
    let id: Int
    let title: FruitTitle
    let image: String
    let price: String
    let color: String


    var name: String { title.rawValue }
    var cardColor: Color { Color(color) }
}

enum FruitTitle: String, CaseIterable, Codable {
    case apple, apricot, avocado, banana, cherry, dragonfruit, fig, orange,
         grapes, raspberry, papaya, kiwi, lemon, blackberry, mango, muskmelon,
         pear, pineapple, plum, strawbery, watermelon
}
